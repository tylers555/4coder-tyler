...
tyler_color_index_asset = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_asset"));
tyler_color_index_function_prototype = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_function_prototype"));
tyler_color_index_sum_type_prototype = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_sum_type_prototype"));
tyler_color_index_product_type_prototype = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_product_type_prototype"));
tyler_color_index_label = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_label"));
tyler_color_index_built_in_function = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_built_in_function"));
tyler_color_index_built_in_variable = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_built_in_variable"));
tyler_color_index_built_in_constant = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_built_in_constant"));
tyler_color_index_glsl_decl_uniform = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_glsl_decl_uniform"));
tyler_color_index_glsl_decl_in = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_glsl_decl_in"));
tyler_color_index_glsl_decl_out = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_index_glsl_decl_out"));
tyler_color_copy = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_copy"));
tyler_color_delete = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("tyler_color_delete"));
